...
export const teamPositions: TeamPosition[] = [
  ...
  { department: 'Testing & Release', role: 'QA & Release Lead', territory: 'GROUP', headcount: 1, phase: 'Day one', engagement: 'Employee or contractor', responsibilities: ['Own test strategy, environments and release gates', 'Coordinate functional, integration, security and user-acceptance testing', 'Issue an evidence-based release recommendation'] },
  ...
  { department: 'Testing & Release', role: 'UK and German UAT & Localisation Tester', territory: 'GROUP', headcount: 2, phase: 'First 90 days', engagement: 'Employee or contractor', responsibilities: ['Test complete customer journeys in English and German', 'Check local wording, currency, dates, policies and communications', 'Record user acceptance and launch blockers by territory'] },
  { department: 'Testing & Release', role: 'Independent Security Tester', territory: 'GROUP', headcount: 1, phase: 'First 90 days', engagement: 'Qualified external adviser', responsibilities: ['Perform independent web, API and mobile security tests', 'Retest critical and high findings', 'Provide a signed report and residual-risk record'] },
...
export const operatingWorkstreams: OperatingWorkstream[] = [
  ...
  { department: 'Testing & Release', territory: 'GROUP', title: 'Testing, UAT and release approval', ownerRole: 'QA & Release Lead', reviewerRole: 'Portfolio Product Manager and territory UAT owner', thirdParty: 'Independent security tester and client acceptance owner', output: 'Unit, integration, end-to-end, role/RLS, payment, accessibility, browser, device, native, security, localisation, UAT and regression evidence linked to a release decision', frequency: 'Every release; full regression before first go-live' },
...
export const thirdPartyActions: ThirdPartyAction[] = [
  ...
  { organisation: 'Independent testing and security providers', category: 'Testing', territory: 'GROUP', internalOwner: 'QA & Release Lead', requiredFromThirdParty: 'Agreed scope, representative environments, independent test execution, severity-rated findings, retest and final report', evidence: 'Statement of work, tester qualifications, report, defect links, retest evidence and residual-risk approval', escalation: 'Head of Product & Engineering and territory Compliance Manager' },
