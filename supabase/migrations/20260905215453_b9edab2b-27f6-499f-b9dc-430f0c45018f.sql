...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.third_party_actions TO authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.compliance_register TO authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.marketing_campaigns TO authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.operating_tasks TO authenticated;
...
GRANT ALL ON public.onboarding_cases TO service_role;
GRANT ALL ON public.onboarding_steps TO service_role;
GRANT ALL ON public.third_party_actions TO service_role;
GRANT ALL ON public.compliance_register TO service_role;
GRANT ALL ON public.marketing_campaigns TO service_role;
GRANT ALL ON public.operating_tasks TO service_role;
